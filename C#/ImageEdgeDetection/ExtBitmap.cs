...
namespace ImageEdgeDetection
{
    ...
    {/// <Özet>
    /// Resmi Kare Tuvale bitmap halinde kopyalayan fonsiyon
    /// Maxside olarak açılan resmin alanı kadar bir tuval oluşturuyor.
    /// </Özet>
    ...
    /// <returns></returns>
        ...
        /// <Özet>
        /// Bu bit map konvolüsyonu alınan bitmapdeki pixel değerlerini kenarbulma algoryitması için siyah tona çeviriyor
        /// </Özet>
        /// <param name="sourceBitmap"></param>
        ...
        /// <Özet>
        /// Bu bit mapi sobel matrisine sokup sobel kenar bulmayı uygulayan fonsiyon
        /// </Özet>
        /// <param name="sourceBitmap"></param>
        /// <param name="grayscale"></param>
        /// <returns></returns>
